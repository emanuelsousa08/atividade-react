      ...
      <section className="overflow-hidden px-5">
        ...
        <ul className="grid list-none p-0">
          {produtos.map((produto) => (
            <li
              key={produto.id}
              className="col-12 md:col-3 shadow-4 p-3 surface-card border-round-md"
            >
              <div className="relative">
                ...
                <div className="absolute top-0 right-0 card-rating text-white py-1 px-2 border-round bg-green-700 text-bold">
                  <i className="text-sm pi pi-star-fill" />{" "}
                  {produto.rating.rate}
                </div>
              </div>
              <h3 className="mb-0 card-title white-space-nowrap overflow-hidden text-overflow-ellipsis">
                {produto.title}
              </h3>
              <h6 className="mb-0 card-category uppercase text-orange-500 uppercase">
                {produto.category}
              </h6>
